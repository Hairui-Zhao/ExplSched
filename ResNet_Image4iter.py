...
def train_res(model, train_dataloader, epoch, since_t):
    model.train()
...
def main():
    ...
    for epoch in range(start_epoch, EPOCH):
        ...
        train_res(model, train_dataloader, epoch, start_t)
